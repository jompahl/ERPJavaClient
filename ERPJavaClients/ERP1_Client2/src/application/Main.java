...
public class Main extends Application {
	...
	public Main() {
		...
		resources.put(Pages.CRONUSVIEW, "/view/CronusView.fxml");
	}
	...
	public void navigate(Pages pageName) {
		...
		Scene scene = new Scene(pane, 782, 600);
		...
		case ERP1CLIENT2:
			...
			break;
		case CRONUSVIEW:
			CronusController controllerCronus = loader.getController();
			controllerCronus.setMain(this);
			//controllerERP1Client2.setDataTable(employeeList);
			break;
		}
	}	
